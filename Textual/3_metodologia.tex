...
Uma vez capturadas e tratadas, as informações desses ``feeds'' poderão ser  direcionadas a um banco de dados. 
Para essa pesquisa foi escolhido o Sistema Gerenciador de Banco de Dados (SGBD) MySQL para tratar esses ``feeds'' do Twitter. 
