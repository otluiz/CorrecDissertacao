...
O CRISP-DM foi concebido, desenvolvido e refinado através workshops entre 1996 à 1999 \cite{Crisp2000}, por três entidades empresariais europeias, consideradas 
``veteranas'' no crescente mercado de mineração de dados, 
a Daimler-Crysler que está a frente da maioria das organizações empresariais e comerciais na aplicação de mineração de dados em seus 
...
O contexto da aplicação do CRISP-DM \cite{Crisp2000} é guiado desde o nível mais genérico até o nível mais especializado, normalmente é explicado em quatro dimensões:
...
\begin{itemize}
 ...
 \item Os aspectos técnicos -- cobre as questões específicas como os desafios usualmente encontrados durante o processo de mineração de dados; 
...
\begin{table}[!ht]
\centering
\caption{Mineração de dados -- contexto}
\label{my-label}
\begin{tabular}{lllll}
\textbf{Dimensão} & \textbf{Domínio da aplicação} & \textbf{Tipo de Problema} & \textbf{Aspecto técnico} & \textbf{Ferramentas e Técnicas} \\ \hline
\textbf{Exemplo}  & Modelo de resposta            & Descrição e sumarização   & Dados faltantes          & Clementine             \\ \hline
      --- 	  & Predição agitada              & Segmentação               & \textit{Outlies}         & MineSet                \\ \hline
      ---         & ---                           & Descrição do conceito     & ---                      & Árvore de decisão      \\ \hline
      ---         & ---                           & Classificação             & ---                      & ---                    \\ \hline
      ---         & ---                           & Predição                  & ---                      & ---                    \\ \hline
      ---         & ---                           & Análise de dependências   & ---                      & ---                    \\ \hline
\end{tabular}
\end{table}
...
\includegraphics[width=130mm, height=70mm]{Figuras/BigData/CrispDM.png}
\end{figure}

O \textbf{Entendimento do negócio} é uma fase crucial da mineração, um especialista (ou muitos) no negócio deve ser consultado. 
...
\subsection{Medindo o desempenho e a qualidade}
