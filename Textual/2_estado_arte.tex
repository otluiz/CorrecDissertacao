...
nesse campo aplicam as técnicas de mineração para obter os melhores resultados.
...
\begin{table}[!ht]
\centering
\caption{Mineração de dados -- contexto \cite{Crisp2000}}
\label{my-label}
\begin{tabular}{lllll}
...
\subsection{Desempenho e a qualidade}
...
\includegraphics[width=150mm, height=90mm]{Figuras/BigData/FayyadSemFundo.png}
\end{figure}
