...
do processo, determinar os objetivos e tração um plano para execução. Essas etapas são delineadas na figura a seguir.

\begin{figure}[!ht]
\centering
\caption{Entendimento do negócio}
\vspace{1mm}
\includegraphics[width=90mm, height=70mm]{Figuras/Cronograma/Entendimento.png}\\
\tiny Fonte: CRISP-DM 1.0
\end{figure}
...
\vspace{1mm}
\includegraphics[width=90mm, height=70mm]{Figuras/Cronograma/EntendDados.png}\\
\tiny Fonte: CRISP-DM 1.0
\end{figure}
...
\vspace{1mm}
\includegraphics[width=90mm, height=70mm]{Figuras/Cronograma/PreparaDados.png}\\
\tiny Fonte: CRISP-DM 1.0
\end{figure}
...
\vspace{1mm}
\includegraphics[width=90mm, height=70mm]{Figuras/Cronograma/Model_IA.png}\\
\tiny Fonte: CRISP-DM 1.0
\end{figure}
...
\vspace{1mm}
\includegraphics[width=90mm, height=70mm]{Figuras/Cronograma/Avaliacao.png}\\
\tiny Fonte: CRISP-DM 1.0
\end{figure}
...
\vspace{1mm}
\includegraphics[width=90mm, height=70mm]{Figuras/Cronograma/Inplantacao.png}\\
\tiny Fonte: CRISP-DM 1.0
\end{figure}
...
\centering
\caption{Rede Neural}
\includegraphics[width=85mm, height=45mm]{Figuras/BigData/redeneural.png}\\
\tiny Fonte: Han, J. and Kamber, M. 
\end{figure}  
...
Outro problema que pode ser encontrado em algoritmos de aprendizagem é o ``overfitting''\\
...
\subsubsection{Tipos de regressão aplicadas a mineração de dados}
...
Nesse contexto, em que se pretende criar modelos computacionais com funcionamento semelhante ao modelo de neurológico humano, surge a chamada neurocomputação. 
No início da década de 40, precisamente em 1943, McCulloch e Pitts \cite{Heaton2008} propuseram o modelo simplificado de como funcionava o cérebro humano e 
sugeriram a construção de uma máquina que fosse inspirada nesse funcionamento.
...
\begin{figure}[!ht]
\centering
\caption{Rede ADALINE (ADAptative LInear Network) e o MADALINE (Many ADALINE) Perceptron}
\vspace{1mm}
\includegraphics[width=90mm, height=40mm]{Figuras/Neural/Adaline.png}\\
\tiny Fonte: http://www.din.uem.br/ia/neurais/neural. Acessado em: 01/10/2016
\end{figure}
...
Essa aproximação, conhecida como erro. Esse erro será propagado de volta à entrada, retroalimentando a rede neural (fase de ``backward''), 
caso o modelo de rede de aproximação seja o ``backpropagation''. Dessa forma a rede neural se aproxima cada vez mais do resultado que foi previa; fase de treinamento.
Uma vez que o erro torna-se infinitamente pequeno dizemos que a rede neural ``não aprende mais'' há uma degradação do sistema, o ``overfitting''.
...
\subsection{Medida de desempenho e qualidade aplicadas à mineração}
