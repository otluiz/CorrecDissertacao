...
Nesse estudo, foram realizadas três frentes de pesquisa para a revisão da literatura: 
  \begin{itemize}
    \item A primeira frente relacionada a modelos preditivos de mineração de dados relacionados à pesquisa em lide;
    \item A segunda frente relacionada às tecnologias mineração em textos em redes socias;
